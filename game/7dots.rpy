...
init -999 python:
    ...
    def_list_sound = "impact"

init -1400:
    # transition для with и для переходов между экранами в виде перелистывания страницы sound=def_list_sound,
    transform TurnPageAt(delay=.5, vertical=False, reverse=False,  new_widget=None, old_widget=None):
        delay delay
        contains:
            events False
...
# автоматическое объявление анимации
    ...
    def fnplay(new_fn, fadein=default_fade, fadeout=default_fade, channel="music", restart=True):
